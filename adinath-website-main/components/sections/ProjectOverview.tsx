      ...
      <Container>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="font-playfair font-light text-white leading-snug text-2xl md:text-3xl">
              An Address That Speaks Before You Do
            </h3>
            <GoldDivider width="sm" />
            <p className="font-dm-sans font-light text-white/50 leading-relaxed text-sm">
              Nestled in Jodhpur&apos;s most coveted residential corridor, ANANTAM stands as a beacon
              of refined living. The project encompasses{' '}
              <span className="text-white/80">200+ meticulously planned residences</span> across
              a B+G+12 tower, offering sweeping views of the Blue City&apos;s iconic skyline.
            </p>
            <p className="font-dm-sans font-light text-white/50 leading-relaxed text-sm">
              With configurations ranging from 2 BHK to ultra-luxury 4 BHK Penthouses, each home
              is a study in spatial generosity — where natural light, ventilation, and view
              are considered as fundamental as walls and floors.
            </p>
            ...
            <div className="inline-flex items-center gap-3 border border-white/10 px-4 py-2.5">
              ...
              <span className="font-dm-sans text-xs tracking-widest text-white/40 uppercase">
                RERA Registered · RJ/JOD/XXXX/XXXX {/* Replace with actual RERA */}
              </span>
            </div>
          </motion.div>
